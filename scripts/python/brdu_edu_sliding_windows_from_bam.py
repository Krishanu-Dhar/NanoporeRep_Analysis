...
modification frequencies using a sliding window approach. This python script takes help of an 
...
The filtered_bed file is just a bedfile that has select read IDs that one wants to process. 

Usage:
    Run this python script with the shell script 'run_brdu_edu_sliding.sh'. The arguments provided in
    the shell script are 'default' arguments. Edit in your own specifics.
